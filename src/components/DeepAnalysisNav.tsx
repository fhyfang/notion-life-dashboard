import { Zap, Clock, Star, Heart, Brain, FileText, Database } from 'lucide-react'
import { motion } from 'framer-motion'

type Page = 'dashboard' | 'energy' | 'time' | 'skills' | 'relationships' | 'metalearning' | 'weekly' | 'database-test';
...
const modules: AnalysisModule[] = [
  ...
  { id: 'database-test', title: '数据库测试', icon: Database, bg: 'bg-yellow-100', color: 'text-yellow-600' },
];
